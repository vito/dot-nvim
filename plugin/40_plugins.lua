...
now_if_args(function()
	...
	if #install_later > 0 then
		ts.install(install_later, { force = true })
	end
...
later(function()
	...
	set({ "n", "x" }, "gl", function()
		mc.matchAddCursor(1)
	end, { desc = "Add cursor at next occurrence" })
	set({ "n", "x" }, "gL", function()
		mc.matchAddCursor(-1)
	end, { desc = "Add cursor at prev occurrence" })
	set({ "n", "x" }, "g>", function()
		mc.matchSkipCursor(1)
	end, { desc = "Skip to next occurrence" })
	set({ "n", "x" }, "g<", function()
		mc.matchSkipCursor(-1)
	end, { desc = "Skip to prev occurrence" })
	set({ "n", "x" }, "gn", function()
		mc.matchAddCursor(1)
